...
const STRINGS = {
  ...
  'day.milestone': {
    'zh-CN': '标记日', 'zh-TW': '標記日', ja: '記念日', ko: '기념일', en: 'Milestone',
  },
  'history.tag': {
  ...
  'sp.version': {
    'zh-CN': '版本 {version}', 'zh-TW': '版本 {version}', ja: 'バージョン {version}', ko: '버전 {version}', en: 'Version {version}',
  },
  'sp.basic': {
    'zh-CN': '基本信息', 'zh-TW': '基本資訊', ja: '基本情報', ko: '기본 정보', en: 'Profile',
  },
  'sp.language': {
  ...
  'sp.birthdate': {
    'zh-CN': '出生日期', 'zh-TW': '出生日期', ja: '生年月日', ko: '생년월일', en: 'Date of birth',
  },
  'sp.timezone': {
  ...
  'sp.saveAs': {
    'zh-CN': '将当前主题另存为自定义主题',
    'zh-TW': '將當前主題另存為自訂主題',
    ja: '現在のテーマをカスタムテーマとして保存',
    ko: '현재 테마를 사용자 지정 테마로 저장',
    en: 'Save current theme as custom',
  },
  'sp.newTheme': {
    'zh-CN': '+ 新建空白主题', 'zh-TW': '+ 新增空白主題', ja: '＋ 新規テーマを作成', ko: '+ 새 테마 만들기', en: '+ New blank theme',
  },
  'sp.themeHint': {
  ...
  'sp.showNumbers': {
    'zh-CN': '在日期格子上显示数字', 'zh-TW': '在日期格子上顯示數字', ja: '日付セルに数字を表示', ko: '날짜 칸에 숫자 표시', en: 'Show numbers in day cells',
  },
  'sp.showAge': {
    'zh-CN': '在年份格子上显示年龄', 'zh-TW': '在年份格子上顯示年齡', ja: '年セルに年齢を表示', ko: '연도 칸에 나이 표시', en: 'Show age in year cells',
  },
  'sp.showQuote': {
  ...
  'sp.showBg': {
    'zh-CN': '显示主题背景图片', 'zh-TW': '顯示主題背景圖片', ja: 'テーマ背景画像を表示', ko: '테마 배경 이미지 표시', en: 'Show theme background image',
  },
  'sp.glass': {
    'zh-CN': '表格毛玻璃效果', 'zh-TW': '表格毛玻璃效果', ja: 'すりガラス効果', ko: '유리(블러) 효과', en: 'Grid glassmorphism',
  },
  'sp.glassHint': {
  ...
  'sp.ms': {
    'zh-CN': '里程碑标记', 'zh-TW': '里程碑標記', ja: '記念日マーク', ko: '기념일 표시', en: 'Milestones',
  },
  'sp.msHint': {
    'zh-CN': '标记生日、纪念日、目标日等特别的日子，对应格子会显示图标。勾选「每年重复」适合生日与纪念日。',
    'zh-TW': '標記生日、紀念日、目標日等特別的日子，對應格子會顯示圖示。勾選「每年重複」適合生日與紀念日。',
    ja: '誕生日・記念日・目標日などを登録すると、その日のセルにアイコンが表示されます。「毎年繰り返す」は誕生日や記念日に。',
    ko: '생일, 기념일, 목표일 등 특별한 날을 등록하면 해당 칸에 아이콘이 표시됩니다. 「매년 반복」은 생일과 기념일에 적합합니다.',
    en: 'Mark special days like birthdays, anniversaries, and goals — the cell shows an icon. "Repeat yearly" suits birthdays and anniversaries.',
  },
  'sp.msEmpty': {
    'zh-CN': '还没有标记。', 'zh-TW': '還沒有標記。', ja: 'まだ登録がありません。', ko: '아직 등록된 기념일이 없습니다.', en: 'No milestones yet.',
  },
  'sp.msLabelPh': {
    'zh-CN': '名称，如：生日', 'zh-TW': '名稱，如：生日', ja: '名前（例：誕生日）', ko: '이름 (예: 생일)', en: 'Name, e.g. Birthday',
  },
  'sp.msRecurring': {
